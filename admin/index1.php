    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                <td class="menu-btn" style="white-space: nowrap;">
                    <a href="doctors.php" class="non-style-link-menu">
                        <div style="display: flex; align-items: center;">
                            <img src="../img/icdoctor.png"style="margin-right: 10px;">
                                ...
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex">
                                        <div>
                                                ...
                                                <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/Dokter.png');"></div>
                                    </div>
                                </td>
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;">
