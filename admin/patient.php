                            ...
                            <tbody>
                                ...
                                if ($result->num_rows == 0) {
                                    ...
                                    for ($x = 0; $x < $result->num_rows; $x++) {
                                        ...
                                        <td><div style="display:flex;justify-content: center; border-bottom: 1px solid var(--Color-Neutral-neutral-100, #C7CACF);"></div></td>
                                        </tr>';
                                    }
                                }
                                ?>
...
if ($_GET) {
    ...
    <div id="popup1" class="overlay">
        <div class="popup">
            <center>
                <a class="close" href="patient">&times;</a>
                ...
                <div style="display: flex;justify-content: center;">
                    <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                        ...
                        <tr>
                            <td colspan="2">
                                <a href="patient"><input type="button" value="OK" class="login-btn btn-primary-soft btn"></a>
                            </td>
                        </tr>
                    </table>
                </div>
