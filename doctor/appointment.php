...
<tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <p class="heading-janjitemu">jumlah Janji Temu : <span style="font-weight: 600;"><?php echo $list110->num_rows; ?></span></p>
...
<div class="header-doc" colspan="4">
                                <div>
                                    <a href="appointment" class="btn-filter-doc" style="padding: 15px; margin :0;width:100%">Reset Filter</a>
                                </div>
...
<!-- Add and Search -->
            ...
            <td colspan="4">
                <center>
                    <div class="abc scroll" style="overflow-x: auto;">
                        <table width="100%" class="sub-table scrolldown" border="0">
                            <thead>
                                <tr>
                                    <th class="table-headin" style="text-align: unset;">
                                        Nama Pasien
                                    </th>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    if($result->num_rows==0){
                                        ...
                                        <br><br><br><br>
                                        <center>
                                        <img src="../img/404-empty.png" width="25%">
                                        <br>
                                        ...
                                        for ($x=0; $x<$result->num_rows; $x++){
                                            ...
                                            echo '<tr>
                                                ...
                                                <td style="text-align:center;font-size:23px;font-weight:500; color: var(--btnnicetext); border-bottom: 1px solid var(--Color-Neutral-neutral-100, #C7CACF)">' . $apponum . '</td> 
                                                <td style="border-bottom: 1px solid var(--Color-Neutral-neutral-100, #C7CACF);">' . substr($title, 0, 15) . '</td>
                                                <td style="text-align:center; border-bottom: 1px solid var(--Color-Neutral-neutral-100, #C7CACF);">' . substr($scheduledate, 0, 10) . '</td>
                                                <td style="text-align:center; border-bottom: 1px solid var(--Color-Neutral-neutral-100, #C7CACF)">' . substr($scheduletime, 0, 5) . '</td>
                                                <td>
