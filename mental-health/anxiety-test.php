...
<body>
        ...
        <div class="container-mental-health">
            <div class="mental-health-row">
                <div style="display: flex; flex-direction: row; flex-wrap: nowrap;">
                    <h1 class="mb-4" style="margin: 0px">Tes Kecemasan</h1>
                </div>
    ...
    <iframe src="question-test/anxiety-question.php" frameborder="0" scrolling="no" onload="resizeIframe(this)" style="width: -webkit-fill-available;"></iframe>
...
<script>
    function redirectToSkorPage() {
        window.location.href = 'skor.html?test=anxiety-test'; // Ganti dengan URL yang sesuai
    }
</script>
