...
<body>
        ...
        <div class="container-mental-health">
            <div class="mental-health-row">
                <div style="display: flex; flex-direction: row; flex-wrap: nowrap;">
                    <h1 class="mb-4" style="margin: 0px">Tes Schizophrenia</h1>
                </div>
                ...
                <p class="mb-4" style="margin-top: 16px;margin-bottom: 0 !important;display: flex;">
                    <img src="../img/checklist.png" alt="Green Checklist Icon" style="vertical-align: middle;margin-right: 8px;height: 100%;width: auto;">
                    Berisi 20 pertanyaan menggunakan skala 0 sampai 3 untuk menghitung skor akhir.
                </p>
                <p class="mb-4" style="margin-top: 16px;margin-bottom: 0 !important;display: flex;">
                    <img src="../img/checklist.png" alt="Green Checklist Icon" style="vertical-align: middle;margin-right: 8px;height: 100%;width: auto;">
    ...
    <iframe src="question-test/schizophrenia-question.php" frameborder="0" scrolling="no" onload="resizeIframe(this)" style="width: -webkit-fill-available;"></iframe>
...
<script>
    function redirectToSkorPage() {
        window.location.href = 'skor.html?test=schizophrenia-test'; // Ganti dengan URL yang sesuai
    }
</script>
